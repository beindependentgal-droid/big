...
export const INITIAL_STORIES: Story[] = [
  {
    ...
    userId: 'm1',
    userName: 'Fatma J.',
    userAvatar: '/images/african_woman_portrait.jpg',
    imageUrl: '/images/african_woman_masterclass.jpg',
  ...
  },
  {
    ...
    userName: 'Sienna N.',
    userAvatar: '/images/african_woman_portrait.jpg',
    imageUrl: '/images/african_woman_founder_portrait.jpg',
  ...
  },
  {
    ...
    userName: 'Dr. Amina',
    userAvatar: '/images/african_woman_portrait.jpg',
    imageUrl: '/images/african_tech_collaboration.jpg',
...
export const INITIAL_CIRCLES: Circle[] = [
  {
    ...
    memberCount: 1250,
    image: '/images/african_tech_collaboration.jpg',
    category: 'connect',
    isJoined: true,
    permissions: {
      whoCanPost: 'anyone',
  ...
  },
  {
    ...
    memberCount: 840,
    image: '/images/african_woman_masterclass.jpg',
    category: 'earn',
    isJoined: false,
    permissions: {
      whoCanPost: 'anyone',
  ...
  },
  {
    ...
    memberCount: 3200,
    image: '/images/african_women_mentorship_lounge.jpg',
    category: 'thrive',
    isJoined: true,
    permissions: {
      whoCanPost: 'anyone',
  ...
  },
  {
    ...
    memberCount: 560,
    image: '/images/african_woman_founder_portrait.jpg',
    category: 'connect',
    isJoined: false,
    permissions: {
      whoCanPost: 'anyone',
...
export const INITIAL_COURSES: Course[] = [
  {
    ...
    category: 'leadership',
    level: 'Beginner',
    thumbnail: '/images/african_tech_collaboration.jpg',
    points: 200,
    students: 1850,
    rating: 4.9,
    lessons: [
  ...
  },
  {
    ...
    category: 'marketing',
    level: 'Beginner',
    thumbnail: '/images/african_women_community.jpg',
    points: 250,
    students: 2400,
    rating: 4.8,
    lessons: [
  ...
  },
  {
    ...
    category: 'finance',
    level: 'Beginner',
    thumbnail: '/images/african_woman_founder_portrait.jpg',
    points: 300,
    students: 3100,
    rating: 4.9,
    lessons: [
  ...
  },
  {
    ...
    category: 'leadership',
    level: 'Advanced',
    thumbnail: '/images/african_woman_keynote_speaker.jpg',
    points: 300,
    students: 950,
    rating: 4.9,
    lessons: [
  ...
  },
  {
    ...
    category: 'creative',
    level: 'Intermediate',
    thumbnail: '/images/african_woman_masterclass.jpg',
    points: 200,
    students: 1400,
    rating: 4.7,
    lessons: [
...
export const INITIAL_CAMPAIGNS: Campaign[] = [
  {
    id: 'camp-1',
    coverImage: '/images/african_woman_masterclass.jpg',
    ...
    gallery: [
      '/images/african_woman_masterclass.jpg',
      '/images/african_tech_collaboration.jpg'
    ]
  },
  {
    id: 'camp-2',
    coverImage: '/images/african_women_mentorship_lounge.jpg',
    ...
    gallery: [
      '/images/african_women_community.jpg'
    ]
  },
  {
    id: 'camp-3',
    coverImage: '/images/african_women_business_meeting.jpg',
  ...
  {
    id: 'camp-4',
    coverImage: '/images/african_tech_collaboration.jpg',
  ...
  {
    id: 'camp-6',
    coverImage: '/images/african_women_community.jpg',
  ...
  {
    id: 'camp-7',
    coverImage: '/images/african_woman_portrait.jpg',
...
export const INITIAL_MONTHLY_SUPPORTERS: MonthlySupporter[] = [
  ...
  },
  {
    ...
    avatar: '/images/african_women_community.jpg',
    amount: 15000,
    tier: 'Platinum Champion',
...
export const INITIAL_IMPACT_STORIES: ImpactStory[] = [
  ...
  },
  {
    ...
    coverImage: '/images/african_woman_founder_portrait.jpg',
