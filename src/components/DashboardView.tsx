  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8 animate-fade-in relative space-y-8" id="analytics-dashboard">
      ...
      <div className="rounded-3xl border border-slate-100 bg-white p-6 shadow-sm space-y-6">
        ...
        <div className="space-y-4">
          {[
            { id: 1, user: 'Wanjiku K.', avatar: '/images/african_woman_portrait.jpg', action: 'earned a new badge', target: 'Founder Pioneer', type: 'badge', time: '2 hours ago', icon: Award, color: 'text-violet-500', bg: 'bg-violet-50' },
            { id: 2, user: 'Ngozi O.', avatar: '/images/african_woman_portrait.jpg', action: 'completed the challenge', target: 'Pitch Deck Mastery', type: 'challenge', time: '4 hours ago', icon: Target, color: 'text-amber-500', bg: 'bg-amber-50' },
            { id: 3, user: 'Aisha M.', avatar: '/images/african_woman_portrait.jpg', action: 'earned a new badge', target: 'Community Star', type: 'badge', time: '5 hours ago', icon: Award, color: 'text-violet-500', bg: 'bg-violet-50' },
            { id: 4, user: 'Grace M.', avatar: '/images/african_woman_portrait.jpg', action: 'completed the challenge', target: 'First 100 Customers', type: 'challenge', time: '1 day ago', icon: Target, color: 'text-amber-500', bg: 'bg-amber-50' },
            { id: 5, user: 'Fatima S.', avatar: '/images/african_woman_portrait.jpg', action: 'earned a new badge', target: 'Mentor', type: 'badge', time: '1 day ago', icon: Award, color: 'text-violet-500', bg: 'bg-violet-50' },
          ].map((activity) => (
