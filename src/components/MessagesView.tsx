...
const MOCK_PHOTOS = [
  { name: 'artisan_weaving_workshop.jpg', size: '2.4 MB', type: 'image' as const, url: '/src/assets/images/african_women_tech_collaboration_1784664040784.jpg' },
  { name: 'shea_butter_packaging.jpg', size: '1.8 MB', type: 'image' as const, url: '/src/assets/images/african_woman_entrepreneur_portrait_1784664054544.jpg' },
  { name: 'mombasa_export_logistics.jpg', size: '3.1 MB', type: 'image' as const, url: '/src/assets/images/african_women_tech_collaboration_1784664040784.jpg' }
];
...
export function MessagesView({
  ...
  const sendCircleMessage = (contentStr: string, attachmentObj?: any) => {
    ...
    const randomSister = activeSistersInCircle.length > 0 
      ...
      : { name: 'Amina Bello', avatar: '/src/assets/images/african_woman_portrait_2_1784708246407.jpg', id: 'm1', rank: 'Learner' };
                ...
                <>
                  ...
                  {activeConv.messages.map((msg) => {
                    ...
                    const senderObj = isMe 
                      ? { name: 'Sarah Jenkins', avatar: '/src/assets/images/african_woman_portrait_2_1784708246407.jpg' }
                      : (activeConv.isGroup 
