...
const communityPosts = [
  ...
  {
    image: '/images/african_woman_keynote_speaker.jpg',
  ...
  {
    image: '/images/african_women_business_meeting.jpg',
...
export function HomeView({ setCurrentView, setCircleTab, members, setToast }: HomeViewProps) {
  ...
  return (
    <div className="animate-fade-in">
          ...
          <div className="relative">
            <div className="overflow-hidden rounded-3xl shadow-xl border border-slate-100 dark:border-slate-800">
              <img referrerPolicy="no-referrer" loading="lazy" decoding="async"
                src="/images/african_women_mentorship_lounge.jpg"
      ...
      {/* NEWSLETTER SIGNUP */}
      <section className="py-20 bg-slate-50 dark:bg-slate-900/50 border-t border-slate-100 dark:border-slate-800 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <NewsletterSignup variant="card" setToast={setToast} />
        </div>
      </section>
