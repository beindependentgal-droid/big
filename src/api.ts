...
export const apiService = {
  ...
  async subscribeNewsletter(email: string, topics?: string[]): Promise<{ success: boolean; message: string; totalSubscribers?: number }> {
  ...
  async getNewsletterSubscribers(): Promise<{ subscribers: Array<{ id: string; email: string; topics: string[]; subscribedAt: string; ip?: string }>; totalCount: number }> {
