      ...
      rollupOptions: {
        output: {
          manualChunks(id) {
            ...
            if (id.includes('/src/components/AdminDashboardView')) return 'admin-dashboard';
            if (id.includes('/src/components/CommunityFeedsView')) return 'community-feeds';
            if (id.includes('/src/components/DashboardView')) return 'dashboard';
            ...
            if (id.includes('/src/components/MySistersView')) return 'my-sisters';
            if (id.includes('/src/components/ResourceLibraryView')) return 'resource-library';
